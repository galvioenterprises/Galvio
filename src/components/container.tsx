 ...
 * the landing page runs 1240 and the product listing runs 1560, because
 * the listing has to carry a filter rail alongside a four-column grid.
 ...
 * cramped.
 */
type Size = "default" | "listing" | "wide";
